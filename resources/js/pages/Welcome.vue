...
// Shared data'dan site bilgilerini al
const page = usePage();
        ...
        <div
            ...
            <main
                ...
                <div
                    ...
                    <h1 class="mb-1 font-medium">{{ site.title }}</h1>
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            ...
                            <span>
                                📱 Dijital kartvizitinizi oluşturun ve QR kod ile paylaşın
                            </span>
                        </li>
                        <li
                            ...
                            <span>
                                🌐 Sosyal medya hesaplarınızı tek bir yerde toplayın
                            </span>
                        </li>
                    </ul>
